...
document.body.addEventListener('htmx:afterOnLoad', function (event) {
  ...
  const target = event.detail.elt // 'elt' is the element that triggered the HTMX request
  const url = target.getAttribute('hx-get') // href also works instead of hx-get
